...
class CygonRectanglePacker(RectanglePacker):
    ...
    I'm quite sure I'm not the first one to come up with it <img src="http://projectdrake.net/blog/wp-includes/images/smilies/icon_smile.gif" alt=":)" class="wp-smiley"> 
